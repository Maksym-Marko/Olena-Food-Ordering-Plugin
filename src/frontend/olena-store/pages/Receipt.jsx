...
import { InfoItem } from '@olenaStore/components/receipt/InfoItem';
import { InfoSection } from '@olenaStore/components/receipt/InfoSection';
import { OrderItem } from '@olenaStore/components/receipt/OrderItem';
import { OrderSummary } from '@olenaStore/components/receipt/OrderSummary';

const Receipt = () => {

    const order = useSelector(state => state.checkout.orderData);
        ...
        <div className="ofo-receipt-container">
            <div className="receipt-header">
                ...
                <div className="order-number">
                    {__('Order #', 'olena-food-ordering')}{order.orderId} - {new Date(order.orderPlaced.utc).toLocaleString('en-US', { month: 'long', day: 'numeric', year: 'numeric', hour: '2-digit', minute: '2-digit', hour12: false })}
                </div>
            </div>
